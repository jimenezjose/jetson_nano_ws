...
: Node("kinect_ros2", options)
{
  ...
  depth_info_manager_ = std::make_shared<camera_info_manager::CameraInfoManager>(
    this, "kinect",
    "file:///home/daddynano/projects/local/xbox360kinect/kinect_ws/install/kinect_ros2/share/kinect_ros2/cfg/calibration_depth.yaml");

  rgb_info_manager_ = std::make_shared<camera_info_manager::CameraInfoManager>(
    this, "kinect",
    "file:///home/daddynano/projects/local/xbox360kinect/kinect_ws/install/kinect_ros2/share/kinect_ros2/cfg/calibration_rgb.yaml");
